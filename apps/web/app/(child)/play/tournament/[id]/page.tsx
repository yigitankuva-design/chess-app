...
/** Canlı turnuva sayfası — Lichess Arena modeli (2026-09-05): round yok,
 *  geri sayım + sıralama (skor + SB averaj + seri 🔥) + "rakip aranıyor"
 *  kuyruğu (WS). Maç bitip bu sayfaya dönünce my_pairing.result dolar,
 *  kuyruk otomatik YENİDEN açılır (aşağıdaki effect, joined/active/
 *  !my_pairing koşuluna bağlı). */
