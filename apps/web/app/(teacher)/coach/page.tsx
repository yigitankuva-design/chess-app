 ...
 *  Madde 2026-09-07 (Antrenör Paneli, 4): antrenör paneli KENDİ anahtarını
 *  kullanır — sporcunun `/home` durumuyla (bea_qa_state_v3) KARIŞMASIN. */
const QA_STATE_KEY = 'bea_coach_qa_state_v1';
...
/**
 * Madde 2026-09-07 (Antrenör Paneli, 1-4): sporcunun Hızlı Erişim
 * sayfasının (`app/(child)/home/page.tsx`) BİREBİR kopyası — Zafer'in
 * isteğiyle antrenör (teacher rolü) kendi hesabıyla giriş yapınca ARTIK
 * `/admin` veya `/classes`'a değil, buraya geliyor. Tasarım/sekme/alt
 * sekme yapısı SPORCU sayfasıyla AYNI kalsın diye bilerek hemen hemen
 * hiçbir mantık değiştirilmedi — içerik farklılaştırması (madde 3:
 * Profil bölümü, ve olası diğer içerik ayrımları) SONRAKİ, ayrı
 * görevlerle yapılacak.
 */
      ...
      {teacherName && (
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-2xl font-extrabold t-premium">{teacherName}</p>
          </div>
        </div>
      )}
