...
describe('CustomTabPanel', () => {
  ...
  it('madde 2026-09-16 (Canlı Ders adlandırması): antrenör "Canlı Ders Oluştur" bölümüne (section_kind=\'online_ders_olustur\') tıklayınca /coach/dersler-canli\'ye gider, akordiyon açılmaz', () => {
    mockRole = 'teacher';
    push.mockClear();
    const tab: CustomTabDetail = {
      id: 4, label: 'Çalışmalar', emoji: '⭐',
      sections: [
        { id: 189, order_index: 3, title: 'Canlı Ders Oluştur', body: '', images: [], practice_positions: [], parent_id: null, section_kind: 'online_ders_olustur' },
      ],
    };
    render(<CustomTabPanel tab={tab} />);
  ...
  it('madde 2026-09-16 (Canlı Ders adlandırması): sporcu tarafında "Canlı Ders Oluştur" bölümüne tıklamak yönlendirme YAPMAZ (normal akordiyon)', () => {
    mockRole = 'child';
    push.mockClear();
    const tab: CustomTabDetail = {
      id: 4, label: 'Çalışmalar', emoji: '⭐',
