...
export function OpeningCategoryCards({
  ...
  /** Madde 2026-09-02: Zafer'in şemasına göre bu panel de a/b/c'ye ayrıldı —
   *  a) Konum Pratiği ve b) Teori Pratiği içerik/davranış kararı bekliyor
   *  (şimdilik yer tutucu), c) Uygulama Pratiği aşağıdaki MEVCUT
   *  tür->açılış->varyant yönetim ağacını DEĞİŞTİRMEDEN içine alır. */
