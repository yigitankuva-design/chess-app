...
# Madde 2026-09-11 (Ödev Sistemi Faz 3): modül/ders seviyeli "Ödevlerim"
# (eski ClassAssignment + GET /assignments) tamamen kaldırıldı — ödev artık
# yalnız Alt Konu üzerinden gönderilir (bkz. tests/test_homework.py).
